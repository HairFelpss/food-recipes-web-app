...
import { updateRecipeRequest } from '~/store/modules/recipe/actions';
...
const editRecipeInputs = [
  ...
  { id: 1, name: 'introduction', placeholder: 'Alterar intrudoção?' },
  {
    ...
    name: 'steps',
    placeholder:
      'Mude os passos da receita, mas lembre-se de separa-los por ";"'
  },
  {
    id: 3,
    name: 'ingredients',
    placeholder: 'Novas idéias de ingredientes? Digite-os separando por ;'
  },
  {
    id: 4,
    name: 'preparation time',
    placeholder: 'Mudou de idéia sobre o tempo de preparo?'
  },
  {
    id: 5,
    name: 'quantity yield',
    placeholder: 'Quantas porções a receita realmente renderá?'
  }
];
...
const EditRecipes = () => {
  ...
  const handleSubmit = async data => {
    try {
      ...
      if (id) {
        dispatch(updateRecipeRequest(filteredData, id));
      }
