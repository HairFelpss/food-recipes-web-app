...
const addRecipeInputs = [
  ...
  { id: 1, name: 'introduction', placeholder: 'Uma breve intrudoção' },
  {
    id: 2,
    name: 'steps',
    placeholder: 'Diga os passos da receita separados por ";"'
  },
  {
    id: 3,
    name: 'ingredients',
    placeholder: 'Liste os ingredientes da receita separados por ";"'
  },
  {
    id: 4,
    name: 'preparation_time',
    placeholder: 'Qual de tempo de preparo da receita'
  },
  ...
  const handleSubmit = async data => {
    try {
      ...
      if (
        ...
        data.photo_id = photo;
        dispatch(createRecipeRequest(data));
      }
    } catch (err) {
